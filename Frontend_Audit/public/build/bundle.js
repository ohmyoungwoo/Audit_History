    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$2, 39, 4, 1091);
    			attr_dev(div0, "class", "card-text");
    			set_style(div0, "white-space", "pre-line");
    			add_location(div0, file$2, 42, 12, 1218);
    			attr_dev(div1, "class", "d-flex justify-content-end");
    			add_location(div1, file$2, 43, 12, 1309);
    			attr_dev(div2, "class", "badge bg-light text-dark p-2");
    			add_location(div2, file$2, 44, 16, 1372);
    			attr_dev(div3, "class", "card-body");
    			add_location(div3, file$2, 41, 8, 1182);
    			attr_dev(div4, "class", "card my-3");
    			add_location(div4, file$2, 40, 4, 1150);
    			attr_dev(textarea, "rows", "10");
    			attr_dev(textarea, "class", "form-control");
    			add_location(textarea, file$2, 52, 12, 1594);
    			attr_dev(div5, "class", "mb-3");
    			add_location(div5, file$2, 51, 8, 1563);
    			attr_dev(input, "type", "submit");
    			input.value = "답변등록";
    			attr_dev(input, "class", "btn btn-primary");
    			add_location(input, file$2, 54, 8, 1682);
    			attr_dev(form, "method", "post");
    			attr_dev(form, "class", "my-3");
    			add_location(form, file$2, 50, 4, 1521);
    			attr_dev(div6, "vlass", "container my-3");
    			add_location(div6, file$2, 37, 0, 1044);
    		},
    		l: function claim(nodes) {
