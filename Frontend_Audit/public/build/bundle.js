...
var app = (function () {
    ...
    const { Error: Error_1$6, Object: Object_1, console: console_1 } = globals;
    ...
    class Router extends SvelteComponentDev {
    	...
    	get routes() {
    		throw new Error_1$6("<Router>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set routes(value) {
    		throw new Error_1$6("<Router>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    */
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 12, 4, 286);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			t = text(t_value);
    			add_location(div0, file$6, 6, 8, 151);
    			attr_dev(div1, "class", "alert alert-danger");
    			attr_dev(div1, "role", "alert");
    			add_location(div1, file$6, 5, 4, 97);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			add_location(strong, file$6, 15, 12, 397);
    			add_location(div, file$6, 14, 8, 379);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*question*/ 1 && a_href_value !== (a_href_value = "/question-modify/" + /*question*/ ctx[0].id)) {
    				attr_dev(a, "href", a_href_value);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    class Detail extends SvelteComponentDev {
    	...
    	get params() {
    		throw new Error_1$4("<Detail>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set params(value) {
    		throw new Error_1$4("<Detail>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    const file$4 = "src/routes/QuestionCreate.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h5, file$4, 28, 4, 652);
    			attr_dev(label0, "for", "subject");
    			add_location(label0, file$4, 32, 12, 804);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "class", "form-control");
    			add_location(input, file$4, 33, 12, 848);
    			attr_dev(div0, "class", "mb-3");
    			add_location(div0, file$4, 31, 8, 773);
    			attr_dev(label1, "for", "content");
    			add_location(label1, file$4, 36, 12, 966);
    			attr_dev(textarea, "class", "form-control");
    			attr_dev(textarea, "rows", "10");
    			add_location(textarea, file$4, 37, 12, 1010);
    			attr_dev(div1, "class", "mb-3");
    			add_location(div1, file$4, 35, 8, 935);
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$4, 39, 8, 1109);
    			attr_dev(form, "method", "post");
    			attr_dev(form, "class", "my-3");
    			add_location(form, file$4, 30, 4, 731);
    			attr_dev(div2, "class", "container");
    			add_location(div2, file$4, 27, 0, 624);
    		},
    		l: function claim(nodes) {
    ...
    const file$2 = "src/routes/UserCreate.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h5, "class", "my-3 border-bottom pb-2");
    			add_location(h5, file$2, 34, 4, 824);
    			attr_dev(label0, "for", "username");
    			add_location(label0, file$2, 38, 12, 963);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "id", "username");
    			add_location(input0, file$2, 39, 12, 1012);
    			attr_dev(div0, "class", "mb-3");
    			add_location(div0, file$2, 37, 8, 932);
    			attr_dev(label1, "for", "password1");
    			add_location(label1, file$2, 42, 12, 1145);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "id", "password1");
    			add_location(input1, file$2, 43, 12, 1193);
    			attr_dev(div1, "class", "mb-3");
    			add_location(div1, file$2, 41, 8, 1114);
    			attr_dev(label2, "for", "password2");
    			add_location(label2, file$2, 46, 12, 1332);
    			attr_dev(input2, "type", "password");
    			attr_dev(input2, "class", "form-control");
    			attr_dev(input2, "id", "password2");
    			add_location(input2, file$2, 47, 12, 1383);
    			attr_dev(div2, "class", "mb-3");
    			add_location(div2, file$2, 45, 8, 1301);
    			attr_dev(label3, "for", "email");
    			add_location(label3, file$2, 50, 12, 1522);
    			attr_dev(input3, "type", "text");
    			attr_dev(input3, "class", "form-control");
    			attr_dev(input3, "id", "email");
    			add_location(input3, file$2, 51, 12, 1565);
    			attr_dev(div3, "class", "mb-3");
    			add_location(div3, file$2, 49, 8, 1491);
    			attr_dev(label4, "for", "no_company");
    			add_location(label4, file$2, 54, 12, 1692);
    			attr_dev(input4, "type", "text");
    			attr_dev(input4, "class", "form-control");
    			attr_dev(input4, "id", "no_company");
    			add_location(input4, file$2, 55, 12, 1739);
    			attr_dev(div4, "class", "mb-3");
    			add_location(div4, file$2, 53, 8, 1661);
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$2, 57, 8, 1845);
    			attr_dev(form, "method", "post");
    			add_location(form, file$2, 36, 4, 903);
    			attr_dev(div5, "class", "container");
    			add_location(div5, file$2, 33, 0, 796);
    		},
    		l: function claim(nodes) {
    ...
    const file$1 = "src/routes/UserLogin.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h5, "class", "my-3 border-bottom pb-2");
    			add_location(h5, file$1, 32, 4, 867);
    			attr_dev(label0, "for", "username");
    			add_location(label0, file$1, 36, 12, 1004);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "class", "form-control");
    			attr_dev(input0, "id", "username");
    			add_location(input0, file$1, 37, 12, 1053);
    			attr_dev(div0, "class", "mb-3");
    			add_location(div0, file$1, 35, 8, 973);
    			attr_dev(label1, "for", "password");
    			add_location(label1, file$1, 40, 12, 1192);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "class", "form-control");
    			attr_dev(input1, "id", "password");
    			add_location(input1, file$1, 41, 12, 1239);
    			attr_dev(div1, "class", "mb-3");
    			add_location(div1, file$1, 39, 8, 1161);
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$1, 43, 8, 1351);
    			attr_dev(form, "method", "post");
    			add_location(form, file$1, 34, 4, 944);
    			attr_dev(div2, "class", "container");
    			add_location(div2, file$1, 31, 0, 839);
    		},
    		l: function claim(nodes) {
    ...
    /* src/routes/QuestionModify.svelte generated by Svelte v3.59.2 */

    const { Error: Error_1 } = globals;
    const file = "src/routes/QuestionModify.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h5, "class", "my-3 border-bottom pb-2");
    			add_location(h5, file, 37, 4, 925);
    			attr_dev(label0, "for", "subject");
    			add_location(label0, file, 41, 12, 1079);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "class", "form-control");
    			add_location(input, file, 42, 12, 1123);
    			attr_dev(div0, "class", "mb-3");
    			add_location(div0, file, 40, 8, 1048);
    			attr_dev(label1, "for", "content");
    			add_location(label1, file, 45, 12, 1241);
    			attr_dev(textarea, "class", "form-control");
    			attr_dev(textarea, "rows", "10");
    			add_location(textarea, file, 46, 12, 1285);
    			attr_dev(div1, "class", "mb-3");
    			add_location(div1, file, 44, 8, 1210);
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file, 48, 8, 1384);
    			attr_dev(form, "method", "post");
    			attr_dev(form, "class", "my-3");
    			add_location(form, file, 39, 4, 1006);
    			attr_dev(div2, "class", "container");
    			add_location(div2, file, 36, 0, 897);
    		},
    		l: function claim(nodes) {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*update_question*/ ctx[3], false, false, false, false)
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('QuestionModify', slots, []);
    	let { params = {} } = $$props;
    	...
    	fastapi("get", "/api/question/detail/" + question_id, {}, json => {
    		$$invalidate(1, subject = json.subject);
    		$$invalidate(2, content = json.content);
    	});

    	function update_question(event) {
    		event.preventDefault();
    		let url = "/api/question/update";
    		let params = { question_id, subject, content };
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<QuestionModify> was created with unknown prop '${key}'`);
    	});
    ...
    class QuestionModify extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    	...
    	get params() {
    		throw new Error_1("<QuestionModify>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set params(value) {
    		throw new Error_1("<QuestionModify>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
