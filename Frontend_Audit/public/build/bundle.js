...
var app = (function () {
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(t4_value);
    			t5 = space();
    			add_location(td0, file$3, 35, 12, 748);
    			attr_dev(a, "href", a_href_value = "/detail/" + /*question*/ ctx[2].id);
    			add_location(a, file$3, 37, 16, 796);
    			add_location(td1, file$3, 36, 12, 775);
    			add_location(td2, file$3, 39, 12, 890);
    			add_location(tr, file$3, 34, 8, 731);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th0, file$3, 27, 12, 569);
    			add_location(th1, file$3, 28, 12, 593);
    			add_location(th2, file$3, 29, 12, 617);
    			attr_dev(tr, "class", "table-dark");
    			add_location(tr, file$3, 26, 8, 533);
    			add_location(thead, file$3, 25, 8, 517);
    			add_location(tbody, file$3, 32, 8, 670);
    			attr_dev(table, "class", "table");
    			add_location(table, file$3, 24, 4, 487);
    			attr_dev(a, "href", "/question-create");
    			attr_dev(a, "class", "btn btn-primary");
    			add_location(a, file$3, 44, 4, 986);
    			attr_dev(div, "class", "container my-3");
    			add_location(div, file$3, 23, 0, 454);
    		},
    		l: function claim(nodes) {
    ...
    const file$2 = "src/components/Error.svelte";
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 12, 4, 286);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			t = text(t_value);
    			add_location(div0, file$2, 6, 8, 151);
    			attr_dev(div1, "class", "alert alert-danger");
    			attr_dev(div1, "role", "alert");
    			add_location(div1, file$2, 5, 4, 97);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			add_location(strong, file$2, 15, 12, 397);
    			add_location(div, file$2, 14, 8, 379);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    const file$1 = "src/routes/Detail.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 39, 4, 1091);
    			attr_dev(div0, "class", "card-text");
    			set_style(div0, "white-space", "pre-line");
    			add_location(div0, file$1, 42, 12, 1218);
    			attr_dev(div1, "class", "d-flex justify-content-end");
    			add_location(div1, file$1, 43, 12, 1309);
    			attr_dev(div2, "class", "badge bg-light text-dark p-2");
    			add_location(div2, file$1, 44, 16, 1372);
    			attr_dev(div3, "class", "card-body");
    			add_location(div3, file$1, 41, 8, 1182);
    			attr_dev(div4, "class", "card my-3");
    			add_location(div4, file$1, 40, 4, 1150);
    			attr_dev(textarea, "rows", "10");
    			attr_dev(textarea, "class", "form-control");
    			add_location(textarea, file$1, 52, 12, 1594);
    			attr_dev(div5, "class", "mb-3");
    			add_location(div5, file$1, 51, 8, 1563);
    			attr_dev(input, "type", "submit");
    			input.value = "답변등록";
    			attr_dev(input, "class", "btn btn-primary");
    			add_location(input, file$1, 54, 8, 1682);
    			attr_dev(form, "method", "post");
    			attr_dev(form, "class", "my-3");
    			add_location(form, file$1, 50, 4, 1521);
    			attr_dev(div6, "vlass", "container my-3");
    			add_location(div6, file$1, 37, 0, 1044);
    		},
    		l: function claim(nodes) {
    ...
    const file = "src/routes/QuestionCreate.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h5, file, 28, 4, 652);
    			attr_dev(label0, "for", "subject");
    			add_location(label0, file, 32, 12, 804);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "class", "form-control");
    			add_location(input, file, 33, 12, 848);
    			attr_dev(div0, "class", "mb-3");
    			add_location(div0, file, 31, 8, 773);
    			attr_dev(label1, "for", "content");
    			add_location(label1, file, 36, 12, 966);
    			attr_dev(textarea, "class", "form-control");
    			attr_dev(textarea, "rows", "10");
    			add_location(textarea, file, 37, 12, 1010);
    			attr_dev(div1, "class", "mb-3");
    			add_location(div1, file, 35, 8, 935);
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file, 39, 8, 1109);
    			attr_dev(form, "method", "post");
    			attr_dev(form, "class", "my-3");
    			add_location(form, file, 30, 4, 731);
    			attr_dev(div2, "class", "container");
    			add_location(div2, file, 27, 0, 624);
    		},
    		l: function claim(nodes) {
