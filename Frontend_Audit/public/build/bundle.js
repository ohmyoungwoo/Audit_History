...
var app = (function () {
    ...
    // (17:4) {#each question_list as question}
    function create_each_block$2(ctx) {
    	let li;
    	let a;
    	let t_value = /*question*/ ctx[2].subject + "";
    	let t;
    	let a_href_value;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$2, 17, 12, 357);
    			add_location(li, file$2, 17, 8, 353);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*question_list*/ 1 && t_value !== (t_value = /*question*/ ctx[2].subject + "")) set_data_dev(t, t_value);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(17:4) {#each question_list as question}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$2, 15, 0, 302);
    		},
    		l: function claim(nodes) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$1, 10, 4, 220);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file$1, 6, 8, 110);
    			add_location(ul, file$1, 5, 4, 97);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, ul, anchor);
    			append_dev(ul, li);
    ...
    // (12:8) {#each error.detail as err, i}
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			add_location(strong, file$1, 13, 12, 289);
    			add_location(li, file$1, 12, 8, 272);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(12:8) {#each error.detail as err, i}",
    		ctx
    	});
    ...
    const file = "src/routes/Detail.svelte";
    ...
    // (44:4) {#each question.answers as answer}
    function create_each_block(ctx) {
    	let li;
    	let t_value = /*answer*/ ctx[8].content + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file, 44, 8, 1161);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*question*/ 1 && t_value !== (t_value = /*answer*/ ctx[8].content + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(li);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(44:4) {#each question.answers as answer}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = space();
    			input = element("input");
    			add_location(h1, file, 37, 0, 1044);
    			add_location(div, file, 39, 0, 1073);
    			add_location(ul, file, 42, 0, 1109);
    			attr_dev(textarea, "rows", "15");
    			add_location(textarea, file, 49, 4, 1254);
    			attr_dev(input, "type", "submit");
    			input.value = "답변등록";
    			add_location(input, file, 50, 4, 1311);
    			attr_dev(form, "method", "post");
    			add_location(form, file, 48, 0, 1229);
    		},
    		l: function claim(nodes) {
    ...
    class Detail extends SvelteComponentDev {
    	...
    	get params() {
    		throw new Error_1("<Detail>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set params(value) {
    		throw new Error_1("<Detail>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Home, Detail, routes });
    	return [routes];
    }
