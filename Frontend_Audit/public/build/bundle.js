...
var app = (function () {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text(t4_value);
    			t5 = space();
    			add_location(td0, file$4, 40, 12, 1136);
    			attr_dev(a, "href", a_href_value = "/detail/" + /*question*/ ctx[12].id);
    			add_location(a, file$4, 42, 16, 1184);
    			add_location(td1, file$4, 41, 12, 1163);
    			add_location(td2, file$4, 44, 12, 1278);
    			add_location(tr, file$4, 39, 8, 1119);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*question_list*/ 2 && t4_value !== (t4_value = /*question*/ ctx[12].create_date + "")) set_data_dev(t4, t4_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th0, file$4, 30, 12, 902);
    			add_location(th1, file$4, 31, 12, 926);
    			add_location(th2, file$4, 32, 12, 953);
    			add_location(th3, file$4, 33, 12, 979);
    			add_location(th4, file$4, 34, 12, 1004);
    			attr_dev(tr, "class", "table-dark");
    			add_location(tr, file$4, 29, 8, 866);
    			add_location(thead, file$4, 28, 8, 850);
    			add_location(tbody, file$4, 37, 8, 1058);
    			attr_dev(table, "class", "table");
    			add_location(table, file$4, 27, 4, 820);
    			attr_dev(button0, "class", "page-link");
    			add_location(button0, file$4, 54, 12, 1537);
    			attr_dev(li0, "class", li0_class_value = "page-item " + (/*$page*/ ctx[0] <= 0 && 'disabled'));
    			add_location(li0, file$4, 53, 8, 1475);
    			attr_dev(button1, "class", "page-link");
    			add_location(button1, file$4, 66, 12, 2090);
    			attr_dev(li1, "class", li1_class_value = "page-item " + (/*$page*/ ctx[0] >= /*total_page*/ ctx[2] - 1 && 'disabled'));
    			add_location(li1, file$4, 65, 8, 2017);
    			attr_dev(ul, "class", "pagination justify-content-center");
    			add_location(ul, file$4, 51, 4, 1397);
    			attr_dev(a, "href", "/question-create");
    			attr_dev(a, "class", "btn btn-primary");
    			add_location(a, file$4, 71, 4, 2224);
    			attr_dev(div, "class", "container my-3");
    			add_location(div, file$4, 26, 0, 787);
    		},
    		l: function claim(nodes) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 12, 4, 286);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			t = text(t_value);
    			add_location(div0, file$3, 6, 8, 151);
    			attr_dev(div1, "class", "alert alert-danger");
    			attr_dev(div1, "role", "alert");
    			add_location(div1, file$3, 5, 4, 97);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			add_location(strong, file$3, 15, 12, 397);
    			add_location(div, file$3, 14, 8, 379);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$3(ctx) {
    	...
    	let t4;
    	let div2;
    	let t5_value = /*question*/ ctx[0].create_date + "";
    	let t5;
    	let t6;
    	let button;
    	let t8;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$2, 40, 4, 1136);
    			attr_dev(div0, "class", "card-text");
    			set_style(div0, "white-space", "pre-line");
    			add_location(div0, file$2, 43, 12, 1263);
    			attr_dev(div1, "class", "d-flex justify-content-end");
    			add_location(div1, file$2, 44, 12, 1354);
    			attr_dev(div2, "class", "badge bg-light text-dark p-2");
    			add_location(div2, file$2, 45, 16, 1417);
    			attr_dev(div3, "class", "card-body");
    			add_location(div3, file$2, 42, 8, 1227);
    			attr_dev(div4, "class", "card my-3");
    			add_location(div4, file$2, 41, 4, 1195);
    			attr_dev(button, "class", "btn btn-secondary");
    			add_location(button, file$2, 49, 4, 1519);
    			attr_dev(textarea, "rows", "10");
    			attr_dev(textarea, "class", "form-control");
    			add_location(textarea, file$2, 57, 12, 1738);
    			attr_dev(div5, "class", "mb-3");
    			add_location(div5, file$2, 56, 8, 1707);
    			attr_dev(input, "type", "submit");
    			input.value = "답변등록";
    			attr_dev(input, "class", "btn btn-primary");
    			add_location(input, file$2, 59, 8, 1826);
    			attr_dev(form, "method", "post");
    			attr_dev(form, "class", "my-3");
    			add_location(form, file$2, 55, 4, 1665);
    			attr_dev(div6, "vlass", "container my-3");
    			add_location(div6, file$2, 38, 0, 1089);
    		},
    		l: function claim(nodes) {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if ((!current || dirty & /*question*/ 1) && t5_value !== (t5_value = /*question*/ ctx[0].create_date + "")) set_data_dev(t5, t5_value);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "href", "/");
    			add_location(a0, file, 8, 8, 248);
    			attr_dev(span, "class", "navbar-toggler-icon");
    			add_location(span, file, 17, 12, 648);
    			...
    			add_location(button, file, 9, 8, 347);
    			attr_dev(a1, "class", "nav-link");
    			attr_dev(a1, "href", "/user-create");
    			add_location(a1, file, 22, 20, 893);
    			attr_dev(li0, "class", "nav-item");
    			add_location(li0, file, 21, 16, 851);
    			attr_dev(a2, "class", "nav-link");
    			attr_dev(a2, "href", "/user-login");
    			add_location(a2, file, 25, 20, 1031);
    			attr_dev(li1, "class", "nav-item");
    			add_location(li1, file, 24, 16, 989);
    			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-lg-0");
    			add_location(ul, file, 20, 12, 790);
    			attr_dev(div0, "class", "collapse navbar-collapse");
    			attr_dev(div0, "id", "navbarSupportedContent");
    			add_location(div0, file, 19, 8, 711);
    			attr_dev(div1, "class", "container-fluid");
    			add_location(div1, file, 7, 4, 210);
