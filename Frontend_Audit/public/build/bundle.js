    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th0, file$4, 34, 12, 988);
    			add_location(th1, file$4, 35, 12, 1012);
    			add_location(th2, file$4, 36, 12, 1039);
    			add_location(th3, file$4, 37, 12, 1065);
    			add_location(th4, file$4, 38, 12, 1090);
    			attr_dev(tr, "class", "table-dark");
    			add_location(tr, file$4, 33, 8, 952);
    			add_location(thead, file$4, 32, 8, 936);
    			add_location(tbody, file$4, 41, 8, 1144);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$2, 44, 4, 1218);
    			attr_dev(div0, "class", "card-text");
    			set_style(div0, "white-space", "pre-line");
    			add_location(div0, file$2, 47, 12, 1345);
    			attr_dev(div1, "class", "d-flex justify-content-end");
    			add_location(div1, file$2, 48, 12, 1436);
    			attr_dev(div2, "class", "badge bg-light text-dark p-2");
    			add_location(div2, file$2, 49, 16, 1499);
    			attr_dev(div3, "class", "card-body");
    			add_location(div3, file$2, 46, 8, 1309);
    			attr_dev(div4, "class", "card my-3");
    			add_location(div4, file$2, 45, 4, 1277);
    			attr_dev(button, "class", "btn btn-secondary");
    			add_location(button, file$2, 54, 4, 1654);
    			attr_dev(textarea, "rows", "10");
    			attr_dev(textarea, "class", "form-control");
    			add_location(textarea, file$2, 63, 12, 1874);
    			attr_dev(div5, "class", "mb-3");
    			add_location(div5, file$2, 62, 8, 1843);
    			attr_dev(input, "type", "submit");
    			input.value = "답변등록";
    			attr_dev(input, "class", "btn btn-primary");
    			add_location(input, file$2, 65, 8, 1962);
    			attr_dev(form, "method", "post");
    			attr_dev(form, "class", "my-3");
    			add_location(form, file$2, 61, 4, 1801);
    			attr_dev(div6, "vlass", "container my-3");
    			add_location(div6, file$2, 42, 0, 1171);
    		},
    		l: function claim(nodes) {
